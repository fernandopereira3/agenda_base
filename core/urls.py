...
urlpatterns = [
    ...
    path("agenda/finalizar/<str:id>/", finalizar_atendimento, name="finalizar_atendimento"),
    path("agenda/finalizar-mobile/<str:id>/", finalizar_mobile_page, name="finalizar_mobile_page"),
    path("agenda/visualizar/<str:id>/", visualizar_atendimento, name="visualizar_atendimento"),
    path("agenda/buscar-clientes/", buscar_clientes, name="buscar_clientes"),
    path("agenda/status/<str:id>/", alterar_status_agendamento, name="alterar_status_agendamento"),
]
