...
class AgendamentoForm(forms.ModelForm):
    class Meta:
        model = Agendamento
        fields = ["cliente_nome", "cliente_telefone", "data_horario", "duracao", "observacoes"]
        widgets = {
            "cliente_nome": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Nome do cliente", "autocomplete": "off"}
            ),
            ...
            "observacoes": forms.Textarea(attrs={"class": "form-control", "rows": 3, "maxlength": 70}),
        }
